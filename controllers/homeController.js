...
export default {
    home: catchAsync(async (req, res, next) => {
      ...
      var courseRatingSubcribeInWeek = courseRatingSubcribe.filter(
      ...
      ListRatingOfField = ListRatingOfField.sort(function(a, b){return b.value - a.value});
